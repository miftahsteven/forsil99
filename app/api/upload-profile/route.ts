...
//membuat API route dengan method PUT untuk mengupdate data alumni berdasarkan id 
//jika ada file foto, maka upload foto ke folder public/profiles dengan nama file {id}.{extensi}
